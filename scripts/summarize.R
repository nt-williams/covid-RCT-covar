...
#to_plot$covar_id <- ifelse(to_plot$covar_id == "LASSO", "ℓ1-LR", to_plot$covar_id)
to_plot$covar_id <- ifelse(to_plot$covar_id == "LASSO", paste0("L", "1-LR"), to_plot$covar_id)

ragg::agg_png("figures/ivan_prez_eff_null_prognostic.png", width = 8, height = 4.5, units = "cm", res = 400)
...
#ragg::agg_png("figures/eff_null_prognostic.png", width = 8, height = 4.5, units = "cm", res = 400)
pdf("figures/eff_null_prognostic.pdf", width = cm_to_inch(8), height = cm_to_inch(4.5))
...
pdf("figures/eff_positive_prognostic.pdf", width = cm_to_inch(8), height = cm_to_inch(4.5))
base_plot1(to_plot[(es != 0 & es != 0.5) & prognostic, ])
dev.off()

#ragg::agg_png("figures/eff_null_not_prognostic.pdf", width = 8, height = 4.5, units = "cm", res = 400)
pdf("figures/eff_null_not_prognostic.pdf", width = cm_to_inch(8), height = cm_to_inch(4.5))
base_plot1(to_plot[(es == 0 | es == 0.5) & !prognostic, ])
dev.off()

#ragg::agg_png("figures/eff_positive_not_prognostic.pdf", width = 8, height = 4.5, units = "cm", res = 400)
pdf("figures/eff_positive_not_prognostic.pdf", width = cm_to_inch(8), height = cm_to_inch(4.5))
base_plot1(to_plot[(es != 0 & es != 0.5) & !prognostic, ])
dev.off()
...
pdf("figures/power_null_prognostic.pdf", width = cm_to_inch(8), height = cm_to_inch(4.5))
...
pdf("figures/power_positive_prognostic.pdf", width = cm_to_inch(8), height = cm_to_inch(4.5))
base_plot2(to_plot[(es != 0 & es != 0.5) & prognostic, ]) + 
...
pdf("figures/power_null_not_prognostic.pdf", width = cm_to_inch(8), height = cm_to_inch(4.5))
base_plot2(to_plot[(es == 0 | es == 0.5) & !prognostic, ]) + 
  geom_bar(aes(x = reorder(covar_id, -power)), stat = "identity", position = "dodge") + 
  geom_hline(yintercept = 0.05, size = 0.15, linetype = "dashed")
dev.off()
...
pdf("figures/power_positive_not_prognostic.pdf", width = cm_to_inch(8), height = cm_to_inch(4.5))
base_plot2(to_plot[(es != 0 & es != 0.5) & !prognostic, ]) + 
  geom_bar(aes(x = reorder(covar_id, power, FUN = sum)), stat = "identity", position = "dodge") 
dev.off()
